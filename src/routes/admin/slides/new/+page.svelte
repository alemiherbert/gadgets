...
<svelte:head>
<title>New Slide — Admin</title>
</svelte:head>

<div class="p-6 lg:p-8">
<div class="mb-6">
<a href="/admin/slides" class="text-sm text-zinc-500 hover:text-zinc-700 transition-colors">← Back to Slides</a>
<h1 class="text-xl font-bold tracking-tight text-zinc-900 mt-2">New Carousel Slide</h1>
</div>
...
<input type="text" id="title" name="title" required class="input" placeholder="e.g. Latest Phones & Tablets" />
</div>
<div>
<label for="sort_order" class="block text-sm font-medium text-zinc-700 mb-1">Sort Order</label>
<input type="number" id="sort_order" name="sort_order" value="0" class="input" />
</div>
</div>

<div>
<label for="subtitle" class="block text-sm font-medium text-zinc-700 mb-1">Subtitle</label>
<textarea id="subtitle" name="subtitle" rows="2" class="input !h-auto" placeholder="Brief description…"></textarea>
</div>
...
<input type="text" id="cta_text" name="cta_text" value="Shop Now" class="input" />
</div>
<div>
<label for="cta_link" class="block text-sm font-medium text-zinc-700 mb-1">Button Link</label>
<input type="text" id="cta_link" name="cta_link" value="/#products" class="input" />
</div>
</div>
...
<select id="bg_image_position" name="bg_image_position" class="input">
...
<p class="text-sm font-bold" style="color: {textColor};">Preview with selected colors & overlay</p>
</div>
</div>
</div>
